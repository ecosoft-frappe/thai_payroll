CUSTOM_FIELDS = {
    ...
    "Employee Tax Exemption Declaration": [
        ...
        {
            "description": "ผู้มีเงินได้อายุ เกิน 65 ปีขึ้นไปได้รับยกเว้น แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "คู่สมรสผู้มีเงินได้อายุเกิน 65 ปีขึ้นไปได้รับยกเว้น แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ผู้มีเงินได้เป็นผุ้พิการและมีอายุไม่เกิน 65 ปีได้รับยกเว้น แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "เงินค่าชดเชยที่ได้รับตามกฎหมายแรงงานได้รับการยกเว้น แต่ไม่เกิน {{amount}} บาท (กรณีนำมารวมคำนวณภาษี)",
        ...
        {
            "description": "ค่าลดหย่อนส่วนตัว {{amount}} บาท",
        ...
        {
            "description": "ลดหย่อนกรณีคู่สมรสไม่มีรายได้ {{amount}} บาท",
        ...
        {
            "description": "บุตรวัยเรียนเกิดก่อนปี พ.ศ. 2561 คนละ {{amount}} บาท",
        ...
        {
            "description": "บุตรวัยเรียนเกิดตั้งแต่ พ.ศ. 2561 คนละ {{amount}} บาท",
        ...
        {
            "description": "รวมยกเว้นการศึกษาบุตร",
        ...
        {
            "description": "เลี้ยงดูบิดากรณีไม่มีรายได้ {{amount}} บาท",
        ...
        {
            "description": "เลี้ยงดูมารดากรณีไม่มีรายได้ {{amount}} บาท",
        ...
        {
            "description": "เลี้ยงดูบิดาของคู่สมรส กรณีคู่สมรสไม่มีรายได้ {{amount}} บาท",            
        ...
        {
            "description": "เลี้ยงดูมารดาของคู่สมรส กรณีคู่สมรสไม่มีรายได้ {{amount}} บาท",
        ...
        {
            "description": "เป็นผู้ดูแลในบัตรประจำตัวของคนพิการ คนละ {{amount}} บาท",
        ...
        {
            "description": "รวม 3 กองทุน ลดหย่อนตามที่จ่ายจริงแต่ไม่เกิน 15% ของเงินได้ที่ต้องเสียภาษี และรวมส่วนนี้ทั้งหมดไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "กองทุนการออมแห่งชาติ ลดหย่อนได้ตามที่จ่ายจริง แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ลดหย่อนตามที่จ่ายจริงแต่ไม่เกิน 30% ของเงินได้",
        ...
        {
            "description": "ค่าเบี้ยประกันชีวิตแบบบำนาญ หักค่าลดหย่อนในอัตราร้อยละ 15 ของเงินได้ที่นำมาเสียภาษีเงินได้ในแต่ละปี แต่ไม่เกิน {{amount}} บาทต่อปี",
        ...
        {
            "description": "เงินสมทบกองทุนประกันสังคม มาตรา 33 ได้ตามจำนวนที่จ่ายจริง แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ค่าฝากครรภ์และค่าคลอดบุตร หักค่าลดหย่อนเท่าที่จ่ายจริง แต่ละคราวไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ประกันชีวิต ตามที่จ่ายจริงแต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ประกันชีวิตคู่สมรส ตามที่จ่ายจริงแต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ประกันสุขภาพ ตามที่จ่ายจริง แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "จ่ายค่าประกันสุขภาพ บิดา/มารดาของตน และบิดา/มารดา ของคู่สมรสที่ไม่มีเงินได้ ให้ได้รับยกเว้นตามจำนวนที่จ่ายจริง แต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "ลดหย่อนตามที่จ่ายจริงแต่ไม่เกิน 30% ของเงินได้ที่ต้องเสียภาษี และไม่เกิน {{amount}} บาท สำหรับปีภาษีที่มีการลงทุน",
        ...
        {
            "description": "ดอกเบื้ยเงินกู้ที่อยู่อาศัย ตามจำนวนที่จ่ายจริงแต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "เงินบริจาคพรรคการเมือง ตามจำนวนที่จ่ายจริงแต่ไม่เกิน {{amount}} บาท",
        ...
        {
            "description": "หักค่าใช้จ่าย 50% ของรายได้ทั้งปี ไม่เกิน {{amount}} บาท",
